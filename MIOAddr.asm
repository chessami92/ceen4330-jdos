...
cursorRow EQU 0fd6dh          ;location in RAM where next character will be printed
cursorColumn EQU 0fd6eh
currentRow EQU 0fd6fh         ;location in RAM of starting character on LCD - 4 rows are displayed
